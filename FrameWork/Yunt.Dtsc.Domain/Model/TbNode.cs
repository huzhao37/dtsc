...
namespace Yunt.Dtsc.Domain.Model
{
    ...
    [DataObject]
    [Description("")]
    [BindTable("tb_node", Description = "", ConnName = "yunt.dtsc", DbType = DatabaseType.MySql)]
    public partial class TbNode : ITbNode
    {
        #region 属性
        private Int32 _ID;
        /// <summary></summary>
        ...
        #region 字段名
        /// <summary>取得TbNode字段信息的快捷方式</summary>
        ...
        /// <summary>取得TbNode字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary></summary>
    ...
    /// <summary>TbNode接口</summary>
    /// <remarks></remarks>
    public partial interface ITbNode
    {
        #region 属性
        /// <summary></summary>
        Int32 ID { get; set; }
