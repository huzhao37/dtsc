...
namespace Yunt.Redis
{
    ...
    ///     String类型操作
    /// </summary>
    public abstract class RedisKey//<T> where T:BaseEntity
    {
        ...
        ///     删除一个key
        /// </summary>
        public void Delete(RedisCachingProvider db = null)
        {
        ...
        /// <param name="db"></param>
        public void Expire(long time, RedisCachingProvider db = null)
        {
            db = RedisCachingProvider.GetClient(db);
        ...
        /// <param name="db"></param>
        /// <returns></returns>
        public int TTL(RedisCachingProvider db = null)
        {
            db = RedisCachingProvider.GetClient(db);
        ...
        /// <returns>对象</returns>
        public T RandKey<T>(RedisCachingProvider db = null)
        {
            db = RedisCachingProvider.GetClient(db);
        ...
        public List<string> Time(RedisCachingProvider db = null)
        {
            db = RedisCachingProvider.GetClient(db);
            return db.Time();
        }
        ...
        /// <typeparam name="T">对象类型</typeparam>
        /// <returns>对象</returns>
        public T Get<T>(RedisCachingProvider db = null)
        {
            db = RedisCachingProvider.GetClient(db);
            return db.Get<T>((string) DataKey, DataType);
        }

        public T GetSet<T>(object value, RedisCachingProvider db = null)
        {
            db = RedisCachingProvider.GetClient(db);
        ...
        public void Set(object value,  RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
        ...
        /// </summary>
        /// <returns></returns>
        public bool Exists( RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
        ...
        /// <param name="value">对象</param>
        /// <returns></returns>
        public bool Rename(object value,  RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
        ...
        public void Set(object value, long? seconds, long? milliseconds, bool? ExistSet,  RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
        ...
        public int Incr( RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
        ...
        /// <returns>执行INCR命令之后key的值</returns>
        public long Incrby(long increment,  RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
        ...
        public void SetValues(object[] values,  RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
        ...
        public int Decr( RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
        ...
        public void MSetValues(object[] values,  RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
            var kvs = new List<Field>();
            var keys = GetKeys;
        ...
        public IList<object> Get(Type[] types,  RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
            return db.Get(types, GetKeys, DataType);
        }

        public IList<object> Get<T, T1>( RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
            return db.Get(new Type[] {typeof (T), typeof (T1)}, GetKeys, DataType);
        }

        public IList<object> Get<T, T1, T2>( RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
            return db.Get(new Type[] {typeof (T), typeof (T1), typeof (T2)}, GetKeys, DataType);
        }

        public IList<object> Get<T, T1, T2, T3>( RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
            return db.Get(new Type[] {typeof (T), typeof (T1), typeof (T2), typeof (T3)}, GetKeys, DataType);
        }

        public IList<object> Get<T, T1, T2, T3, T4>( RedisCachingProvider db = null)
        {
            db =  RedisCachingProvider.GetClient(db);
